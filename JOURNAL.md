...
I made a new version with a microsd card reader and a microsd to usb controller. That was so painful. It also looks really ugly.
...
I made the final version, featuring a usb-c port to connect to a computer, two usb-a ports, one usb-c port, and a microsd card reader. I'm very proud of the final outcome, but there is a non-zero chance that it just completely doesn't work...

<img width="627" height="646" alt="image" src="https://github.com/user-attachments/assets/1ee8b9d4-e429-4f93-8034-7495f80a3289" />
